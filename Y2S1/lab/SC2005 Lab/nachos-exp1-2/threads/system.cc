...
#ifdef CHANGED
MemoryTable *memoryTable;               // flags of memory status, etc...
#endif
...
{
  /* Experiment 2 */
  /*Identify where the timer is initialized in this file. Activate the initialization of the timer by updating appropriate variables.*/
