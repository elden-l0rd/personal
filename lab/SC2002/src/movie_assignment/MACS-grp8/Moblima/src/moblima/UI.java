...
public class UI {
	...
	public void admin() throws IOException {
		 int choice2;
	        ...
	        System.out.println("1. Show Preview movies\n"+
	                            "2. Show NOW SHOWING movies\n"+
	                            "3. Show COMING SOON movies\n"+
	...
	public void user(boolean userAcct) throws IOException {
		...
		if(userAcct)
			System.out.println("|===============|User Mode|===============|");
			  ...
			  switch(c.getUserView()) {
			   case 1:
			    System.out.println("6. List Top 5 Ranking Movies by ticket sales\n"+
			         "8. Assign movie rating and review\n"); //require login function);
			    break;
			   case 2:
			    System.out.println("7. List Top 5 Ranking Movies by overall reviewer's ratings\n"+
			         "8. Assign movie rating and review\n"); //require login function
			    break;
			   case 3:
			    System.out.println("6. List Top 5 Ranking Movies by ticket sales\n" +
	...
	public void purchaseTickets() {
		...
		Customer newuser = new Customer(name,mobile,email);
